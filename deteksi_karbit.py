...
# Inisialisasi prolog
prolog = Prolog()
prolog.consult("deteksi_karbit.pl")
penyakit = list()
gejala = dict()
index_penyakit = 0
index_gejala = 0
...
ttk.Label(mainframe, text="Sistem Pakar Deteksi Karbit", font=("Arial", 16)).grid(column=0, row=0, columnspan=3)
ttk.Label(mainframe, text="Jawablah pertanyaan berikut:").grid(column=0, row=1)
